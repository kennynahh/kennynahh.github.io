...
const FILES = {
  'about_me.txt': [
    ...
    L.b(),
    L.t('Currently leading electrical at WARG (Waterloo'),
    L.t('Aerial Robotics Group). Previously hardware intern'),
    L.t('at Arista Networks (800GbE switch silicon) and'),
    L.t('Etched (custom AI-inference chips), and founder /'),
  ...
  'projects/warg.md': [
    ...
    L.t('  - Custom STM32-based flight controller with'),
    ...
    L.t('  - H-bridge MOSFET selection via conducting +'),
    L.t('    switching power-loss and max-temperature'),
    L.t('    analysis.'),
    L.b(),
